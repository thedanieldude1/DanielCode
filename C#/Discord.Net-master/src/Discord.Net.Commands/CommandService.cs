...
namespace Discord.Commands
{
	public partial class CommandService : IService
    {
        ...
        public Dictionary<string, CommandMap> _categories;
        public CommandMap _map; //Command map stores all commands by their input text, used for fast resolving and parsing
